...
interface ChatMessagesProps {
  ...
  onRetry?: () => void;
  onClear?: () => void;
  isRoomView: boolean; // Indicates if this is a room view (vs Mark chat)
  roomId?: string; // Needed for message deletion calls
  isAdmin?: boolean; // Whether the current user has admin privileges (e.g. username === "mark")
  ...
  return (
    <AnimatePresence initial={false} mode="sync">
      ...
      {messages.map((message) => {
        ...
        // In chat rooms, messages from mark don't have a role, just a username
